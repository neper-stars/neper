...
func TestUserProfileCreateHandler(t *testing.T) {
	...
	t.Run("create gandalf", func(t *testing.T) {
		...
		// Users created by global managers should be active
		require.Equal(t, models.UserProfileStateActive, user.State, "user should be active")
		...
		require.Equal(t, models.UserProfileStateActive, saroumaneUser.State, "user should be active after re-read")
	})
}
