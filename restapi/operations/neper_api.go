...
func NewNeperAPI(spec *loads.Document) *NeperAPI {
	return &NeperAPI{
		...
		InvitationSentListHandler: InvitationSentListHandlerFunc(func(params InvitationSentListParams, principal *models.Principal) middleware.Responder {
			return middleware.NotImplemented("operation InvitationSentList has not yet been implemented")
		}),
		...
		SessionPlayerRaceDeleteHandler: SessionPlayerRaceDeleteHandlerFunc(func(params SessionPlayerRaceDeleteParams, principal *models.Principal) middleware.Responder {
			return middleware.NotImplemented("operation SessionPlayerRaceDelete has not yet been implemented")
		}),
...
type NeperAPI struct {
	...
	// InvitationSentListHandler sets the operation handler for the invitation sent list operation
	InvitationSentListHandler InvitationSentListHandler
	...
	SessionPlayerRaceDeleteHandler SessionPlayerRaceDeleteHandler
...
func (o *NeperAPI) Validate() error {
	...
	if o.InvitationSentListHandler == nil {
		unregistered = append(unregistered, "InvitationSentListHandler")
	}
	...
	if o.SessionPlayerRaceDeleteHandler == nil {
		unregistered = append(unregistered, "SessionPlayerRaceDeleteHandler")
	}
...
func (o *NeperAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/v1/invitations/sent"] = NewInvitationSentList(o.context, o.InvitationSentListHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["DELETE"]["/v1/sessions/{session_id}/player_race/{player_race_id}"] = NewSessionPlayerRaceDelete(o.context, o.SessionPlayerRaceDeleteHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
