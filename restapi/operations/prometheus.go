...
func (o *NeperAPI) PrometheusInstrumentHandlers() {
	...
	o.handlers["GET"]["/v1/downloads/stars.exe"] = DownloadStarsExeInstrumentHandler(
	...
	o.handlers["POST"]["/v1/sessions/{session_id}/archive"] = SessionArchiveInstrumentHandler(
	...
	o.handlers["DELETE"]["/v1/sessions/{session_id}/player_race/{player_race_id}"] = SessionPlayerRaceDeleteInstrumentHandler(
	...
	o.handlers["POST"]["/v1/sessions/{session_id}/quit"] = SessionQuitInstrumentHandler(
